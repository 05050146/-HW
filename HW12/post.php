...
if(isset($_POST["action"])&&($_POST["action"]=="add")){//*
	$query_insert = "INSERT INTO `board` (`boardname` ,`boardsex` ,`boardsubject` ,`boardtime` ,`boardmail` ,`boardweb` ,`boardcontent`) ";//*
	$query_insert .= "'".$POST["boardname"]."',";
	$query_insert .= "'".$POST["boardsex"]."',";
	$query_insert .= "'".$POST["boardsubject"]."',";
	$query_insert .= "'NOW(),";
	$query_insert .= "'".$POST["boardmail"]."',";
	$query_insert .= "'".$POST["boardweb"]."',";
	$query_insert .= "'".$POST["boardcontent"]."',";
