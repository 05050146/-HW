...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td background="images/board_r3_c1.jpg"><div id="mainRegion">
        <?php while($row_RecBoard=mysql_fetch_assoc($RecBoard)){//50-73?> 
        <table width="90%" border="0" align="center" cellpadding="4" cellspacing="0">
		 <tr valign="top">
          <td width="60" align="center" class="underline"><?php if($row_RecBoard["boardsex"]=='男'){;?>
			...
			<?php }else{?>
			<img src="image/female.gif" alt="我是女生" width='49' height='49'>
			<?php }?>
			<br>
			<span class="postname"><?php echo $row_RecBoard["boardname"];?></span></td>
				<td class="underline"><span class="smalltext">[<?php echo $row_RecBoard["boardid"];?>]</span><span class="heading">123</td>
			...
			<a href ="mailto:<?php echo $row_RecBoard["boardmail"];?>"><img src="image/email-a.png" alt="電子郵件" width="16" height="36" border="0"> 
			<?php }?>
			<?php if($row_RecBoard["boardweb"]!=""){?>
			<a href ="<?php echo $row_RecBoard["boardweb"];?>"><img src="image/home-a.png" alt="個人網站" width="16" height="36" border="0"> 
			<?php }?>
			</p></td>
		</tr>
		</table>
